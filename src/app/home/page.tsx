    ...
    return (
        <div className={styles.all}>
            <main className={styles.css}>
                ...
                <h2 className={styles.h2}>¿Quienes somos?</h2>
                <section>
                    ...
                    />
                    <h2 className={styles.h2}>¿Resulta complicado confiar?</h2>
                    <Homes
                        src="/Images/estudio.jpg"
                        src2="/Images/estadistica.jpg"
                        alt="XD"
                        ...
                        width={40}
                        width2={300}
                        title="Estructura y Gestión De La App"
                        title2="Con que se elabora"
                        text="Permite a los clientes estructurar y gestionar tareas grupales,permitiendo cumpartir y acceder a tareas simultaneamente"
                        text2="Elaboradas de forma sotfware"
                    />
                    <h2 className={styles.h2}>¿Resulta complicado confiar?</h2>
                    <Homes
                    ...
                    <div>
                    <section>
                        <p>, logramos una compatibilidad en dispositivos y webs, el diseño no es complejo es un diseño simple y facil de usar ideal para clientes de todas las edades la proteccion de los datos y control de las salas son protegidas por ???????????????, las notificaciones permitiran a los clientes acordar sobre sus tareas pendientes y fechas limite.</p>
                    </section>
                    <section>
